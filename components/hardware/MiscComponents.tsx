...
// FIX: The RefWrapper component was removed to solve ref forwarding issues.
// Each component now uses a simple `div` wrapper to correctly forward the ref.
export const Potentiometer = React.forwardRef<HTMLDivElement>((props, ref) => (
  <div ref={ref} className="select-none" style={{ userSelect: 'none' }}>
